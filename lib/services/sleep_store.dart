...
class SleepStore {
  ...
  /// Marks Poko awake now (call after a successful wake-up).
  ...
  /// During night window, Poko may voluntarily sleep again after wake.
  ...
  /// During a sleep window, put Poko back to sleep after a wake.
