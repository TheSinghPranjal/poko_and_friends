...
/// Identifiers for scheduled Poko habits (home rings + settings).
enum ActivityId {
  drink,
  play,
  feed,
...
abstract final class DefaultSchedules {
  ...
  /// How long Poko stays awake after a wake-up during noon nap.
  static const awakeAfterWakeMinutes = 60;

  /// How long Poko stays awake after a wake-up during night (10pm–6am).
